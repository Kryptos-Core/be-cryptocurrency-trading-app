...
Skills trong repo này **đã lọc theo NestJS/backend**: đã bỏ các gói chéo stack (Flutter/Dart, Playwright UI web, React/Next). Skill backend chính ở **Cursor**: `.cursor/skills/nestjs-patterns/`, `backend-patterns/`, `database-migrations/`.
