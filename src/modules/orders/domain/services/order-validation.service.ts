...
export interface OrderValidationServicePort {
  validate(context: OrderValidationContext): void;
}

/**
 * Domain service that validates business invariants before order placement.
 */
export class OrderValidationService implements OrderValidationServicePort {
  validate(context: OrderValidationContext): void {
