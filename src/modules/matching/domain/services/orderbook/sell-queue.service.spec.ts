...
describe('SellQueueService', () => {
  ...
  it('sorts by best ask then oldest time', () => {
    service.add(
      order({ order_id: 'o1', price: '101', created_at: new Date('2025-01-01T00:00:02Z') }),
    );
    service.add(
      order({ order_id: 'o2', price: '100', created_at: new Date('2025-01-01T00:00:03Z') }),
    );
    service.add(
      order({ order_id: 'o3', price: '100', created_at: new Date('2025-01-01T00:00:01Z') }),
    );
