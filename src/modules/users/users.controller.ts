...
export class UsersController {
  constructor(
    ...
    private readonly requestSecurityChangeUseCase: RequestSecurityChangeUseCase,
    private readonly reviewSecurityChangeUseCase: ReviewSecurityChangeUseCase,
  ...
  async findAll(@Query() filters: UserFilterDto) {
    return this.getUsersQuery.findAll(filters);
  }
  ...
  @ApiUnauthorizedResponse('Unauthorized')
  async getStatistics() {
    return this.getUsersQuery.getStatistics();
  }
  ...
  async updateProfileBasic(
    ...
    return this.updateProfileBasicUseCase.execute(userId, dto);
  }
  ...
  async requestSecurityChange(
    ...
    return this.requestSecurityChangeUseCase.execute(userId, dto);
  }
  ...
  async uploadAvatar(
    ...
    return this.uploadAvatarUseCase.execute(userId, file.buffer);
  }
  ...
  async getPendingSecurityChangeRequests() {
    return this.getUsersQuery.getPendingSecurityChangeRequests();
  }
  ...
  async approveSecurityChangeRequest(
    ...
    return this.reviewSecurityChangeUseCase.execute(requestId, reviewerUserId, {
      ...dto,
      approve: true,
    });
  }
  ...
  async getUserWallets(@Param('id') id: string) {
    return this.getUsersQuery.getUserWallets(id);
  }
  ...
  async getUserOnchainTransactions(
    ...
    return this.getUsersQuery.getUserOnchainTransactions(id, page, limit);
  }
  ...
  async getUserSecurityChanges(
    ...
    return this.getUsersQuery.getUserSecurityChanges(id, page, limit);
  }
  ...
  async saveFcmToken(
    ...
    await this.saveFcmTokenUseCase.execute(userId, fcmToken ?? null);
  }
  ...
  async getUserOrders(
    ...
    return this.getUsersQuery.getUserOrders(id, page, limit, status);
  }
