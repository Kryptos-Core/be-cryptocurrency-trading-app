...
describe('AdminAdjustBalanceUseCase', () => {
  ...
  describe('DEPOSIT type', () => {
    it('creates adjustment, credits wallet, writes ledger entry, and publishes event', async () => {
      ...
      // CREDIT = DEPOSIT type → deltaAvailable = +100, deltaFrozen = 0
