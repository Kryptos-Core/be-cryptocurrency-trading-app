...
function makeAdjustment(overrides: Partial<{ adjustmentId: string; actorUserId: string; targetUserId: string; currencyId: string; amount: string; type: string; note: string | null; createdAt: string }> = {}) {
 return {
 adjustmentId: 'adj-1',
